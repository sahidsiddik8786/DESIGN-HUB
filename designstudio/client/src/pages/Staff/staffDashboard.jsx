...
const StaffHome = () => {
    const backgroundStyle = {
        backgroundImage: 'url("https://images.pexels.com/photos/886023/pexels-photo-886023.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2")', // Replace "path/to/your/image.jpg" with the actual path to your image file
  ...
  <Link to="/staffprofileup" className="text-decoration-none text-dark">
    ...
    >
      <div>
        <h3 className="fs-3"> Update Profile </h3>
